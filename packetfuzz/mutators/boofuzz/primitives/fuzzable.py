...
class Fuzzable:
    ...
    def __init__(self, name=None, default_value=None, fuzzable=True, fuzz_values=None):
        ...
        if self._name is None:
            ...
            self._name = f"__FUZZABLE__{Fuzzable.name_counter:08d}__"
    ...
    def qualified_name(self):
        if self._context_path:
            return f"{self._context_path}.{self.name}"
        else:
            return self.name
    ...
    def __len__(self):
        ...
        """
        try:
            rendered = self.render(MutationContext())
            return len(rendered) if hasattr(rendered, '__len__') else 0
        except:
            return 0
